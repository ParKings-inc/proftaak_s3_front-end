import DeleteReservation from "../../../components/Reservations/Delete/DeleteReservation";
...
const ReservationDeletePage = (props) => {
        ...
        <div className='center mt-25'>
            ...
            <div className='flex row mb-25'>
                ...
                <div className='w-auto flex flex-col items-center'>
                    <Typography variant='h5'>Cancel this reservation?</Typography>
                </div>
            </div>
            <DeleteReservation reservation={reservation}></DeleteReservation>
        </div>
